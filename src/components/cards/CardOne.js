...
export default function CardOne({ title, description, imageUrl }) {
  return (
    <div className="max-w-lg mx-auto mt-8 space-y-2 p-8 bg-gradient-to-tr from-indigo-500 to-indigo-600 rounded-lg shadow-md shadow-slate-300 sm:flex items-center sm:py-4 sm:space-x-6">
      {/* <img
        src={imageUrl}
